  ...
  return (function () {
    ...
    var t = {
              ...
              return (
                ...
                (e.prototype.enable = function () {
                  !1 !== this.disabled &&
                    ...
                    l.isTouch &&
                      (this.dragEl.addEventListener("touchstart", l.touchstart),
                ...
                (e.prototype._mouseMove = function (t) {
                  ...
                  if (this.dragging)
                    if ((this._dragFollow(t), r.DDManager.pauseDrag)) {
                      var n = Number.isInteger(r.DDManager.pauseDrag)
                        ? r.DDManager.pauseDrag
                        : 100;
                      this.dragTimeout && window.clearTimeout(this.dragTimeout),
                    ...
                    var a =
                      null === (e = this.el.gridstackNode) || void 0 === e
                        ? void 0
                        : e.grid;
                    a
                      ? (r.DDManager.dropElement = a.el.ddElement.ddDroppable)
                      : delete r.DDManager.dropElement,
                ...
                (e.prototype._mouseUp = function (t) {
                  ...
                  if (
                    ...
                    delete this.dragging,
                      (null === (e = r.DDManager.dropElement) || void 0 === e
                        ? void 0
                        : e.el) === this.el.parentElement &&
                        delete r.DDManager.dropElement,
                      ...
                      this.helper === this.el
                        ...
                        : this.helper.remove();
                    var i = s.Utils.initEvent(t, {
                      target: this.el,
                      type: "dragstop",
                    });
                    this.option.stop && this.option.stop(i),
                      this.triggerEvent("dragstop", i),
                      r.DDManager.dropElement &&
                        r.DDManager.dropElement.drop(t);
                  }
                  delete this.helper,
                    delete this.mouseDownEvent,
                    delete r.DDManager.dragElement,
                    delete r.DDManager.dropElement,
                    delete r.DDManager.mouseHandled,
                    t.preventDefault();
                }),
                (e.prototype._createHelper = function (t) {
                  ...
                  return (
                    ...
                    o === this.el &&
                      (this.dragElementOriginStyle = e.originStyleProp.map(
                        function (t) {
                          return i.el.style[t];
                        }
                      )),
                ...
                (e.prototype._removeHelperStyle = function () {
                  ...
                  var o =
                    null === (t = this.helper) || void 0 === t
                      ? void 0
                      : t.gridstackNode;
                  if (
                    this.dragElementOriginStyle &&
                    (!o || !o._isAboutToRemove)
                  ) {
                    var n = this.helper,
                      r = this.dragElementOriginStyle.transition || null;
                    (n.style.transition =
                      this.dragElementOriginStyle.transition =
                        "none"),
                      e.originStyleProp.forEach(function (t) {
                        return (n.style[t] =
                          i.dragElementOriginStyle[t] || null);
                      }),
                      setTimeout(function () {
                ...
                (e.prototype.ui = function () {
                  ...
                  return {
                    position: { top: e.top - t.top, left: e.left - t.left },
                  };
                }),
                (e.originStyleProp = [
                  "transition",
              ...
              return (
                ...
                (e.prototype.enable = function () {
                  !1 !== this.disabled &&
                    ...
                    d.isTouch &&
                      (this.el.addEventListener("pointerenter", d.pointerenter),
                ...
                (e.prototype._mouseEnter = function (t) {
                  if (
                    ...
                    this._canDrop(s.DDManager.dragElement.el)
                  ) {
                    t.preventDefault(),
                      t.stopPropagation(),
                      s.DDManager.dropElement &&
                        s.DDManager.dropElement !== this &&
                        s.DDManager.dropElement._mouseLeave(t),
                      (s.DDManager.dropElement = this);
                    ...
                    this.option.over &&
                      this.option.over(e, this._ui(s.DDManager.dragElement)),
                ...
                (e.prototype.drop = function (t) {
                  ...
                  this.option.drop &&
                    this.option.drop(e, this._ui(s.DDManager.dragElement)),
            ...
            s = (function () {
              ...
              return (
                ...
                (t.prototype.on = function (t, e) {
                  return (
                    this.ddDraggable &&
                    ["drag", "dragstart", "dragstop"].indexOf(t) > -1
                      ? this.ddDraggable.on(t, e)
                      : this.ddDroppable &&
                        ["drop", "dropover", "dropout"].indexOf(t) > -1
                      ? this.ddDroppable.on(t, e)
                      : this.ddResizable &&
                        ["resizestart", "resize", "resizestop"].indexOf(t) >
                          -1 &&
        ...
        502: function (t, e, i) {
          ...
          var n = i(855),
            ...
            d = (function () {
              ...
              return (
                ...
                (t.prototype.resizable = function (t, e, i, n) {
                  return (
                  ...
                  return (
                    this._getDDElements(t).forEach(function (t) {
                      ...
                      if ("disable" === e || "enable" === e)
                        ...
                        t.setupDraggable((((r = {})[i] = n), r));
                      else {
                        var s = t.el.gridstackNode.grid;
                        t.setupDraggable(
                          o(o({}, s.opts.draggable), {
                            start: e.start,
                            stop: e.stop,
                            drag: e.drag,
                          })
                  ...
                  return (
                    this._getDDElements(t).forEach(function (t) {
                      return t.on(e, function (t) {
                        i(
                          t,
                          a.DDManager.dragElement
                            ? a.DDManager.dragElement.el
                            : t.target,
                          a.DDManager.dragElement
                            ? a.DDManager.dragElement.helper
                            : null
                        );
                      });
                    }),
                ...
                (t.prototype._getDDElements = function (t, e) {
                  void 0 === e && (e = !0);
                  var i = s.Utils.getElements(t);
                  if (!i.length) return [];
                  var o = i.map(function (t) {
                    return t.ddElement || (e ? l.DDElement.init(t) : null);
                  });
                  return (
                    e ||
                      o.filter(function (t) {
          ...
          (r.GridStack.prototype._setupAcceptWidget = function () {
            var t,
              e,
              i = this;
            if (
            ...
            var n = function (o, n, r) {
              ...
              if (a) {
                ...
                var l = i.el.getBoundingClientRect(),
                  ...
                  p = d.left;
                p -= l.left;
                var c = { position: { top: (u -= l.top), left: p } };
                if (a._temporaryRemoved) {
                  if (
                    ((a.x = Math.max(0, Math.round(p / e))),
                    (a.y = Math.max(0, Math.round(u / t))),
                    delete a.autoPosition,
                    i.engine.nodeBoundFix(a),
                    !i.engine.willItFit(a))
                  ) {
                    if (((a.autoPosition = !0), !i.engine.willItFit(a)))
                      return void h.off(n, "drag");
                    a._willFitPos &&
                      (s.Utils.copyPos(a, a._willFitPos), delete a._willFitPos);
                  }
                  i._onStartMoving(r, o, c, a, e, t);
                } else i._dragOrResize(r, o, c, a, e, t);
              }
            };
            return (
              h
                .droppable(this.el, {
                  accept: function (t) {
                    ...
                    if ("function" == typeof i.opts.acceptWidgets)
                      ...
                      var n =
                        !0 === i.opts.acceptWidgets
                          ? ".grid-stack-item"
                          : i.opts.acceptWidgets;
                      o = t.matches(n);
                    }
                ...
                .on(this.el, "dropover", function (r, s, a) {
                  ...
                  if (
                    (null == l ? void 0 : l.grid) === i &&
                    !l._temporaryRemoved
                  )
                    return !1;
                  (null == l ? void 0 : l.grid) &&
                    l.grid !== i &&
                    !l._temporaryRemoved &&
                    l.grid._leave(s, a),
                    (e = i.cellWidth()),
                    (t = i.getCellHeight(!0)),
                    l || (l = i._readAttr(s)),
                    l.grid || ((l._isExternal = !0), (s.gridstackNode = l)),
                    (a = a || s);
                  var d = l.w || Math.round(a.offsetWidth / e) || 1,
                    p = l.h || Math.round(a.offsetHeight / t) || 1;
                  return (
                    l.grid && l.grid !== i
                      ? (s._gridstackNodeOrig || (s._gridstackNodeOrig = l),
                        (s.gridstackNode = l =
                          o(o({}, l), { w: d, h: p, grid: i })),
                        i.engine.cleanupNode(l).nodeBoundFix(l),
                        (l._initDD = l._isExternal = l._temporaryRemoved = !0))
                      : ((l.w = d), (l.h = p), (l._temporaryRemoved = !0)),
                    u(l.el, !1),
                    h.on(s, "drag", n),
                    n(r, s, a),
                    !1
                ...
                .on(this.el, "dropout", function (t, e, o) {
                  ...
                  return (
                    !!n &&
                    ((n.grid && n.grid !== i) ||
                      (i._leave(e, o), i._isTemp && i.removeAsSubGrid(n)),
                    !1)
                  );
                })
                .on(this.el, "drop", function (t, e, n) {
                  var r,
                    a,
                    l = e.gridstackNode;
                  if ((null == l ? void 0 : l.grid) === i && !l._isExternal)
                    return !1;
                  var d = !!i.placeholder.parentElement;
                  i.placeholder.remove();
                  var u = e._gridstackNodeOrig;
                  if (
                    (delete e._gridstackNodeOrig,
                    d && (null == u ? void 0 : u.grid) && u.grid !== i)
                  ) {
                    var p = u.grid;
                    p.engine.removedNodes.push(u),
                      p._triggerRemoveEvent(),
                      p.parentGridItem &&
                        !p.engine.nodes.length &&
                        p.removeAsSubGrid();
                  }
                  if (!l) return !1;
                  if (
                    (d && (i.engine.cleanupNode(l), (l.grid = i)),
                    h.off(e, "drag"),
                    n !== e
                      ? (n.remove(),
                        (e.gridstackNode = u),
                        d && (e = e.cloneNode(!0)))
                      : (e.remove(), i._removeDD(e)),
                    !d)
                  )
                    return !1;
                  (e.gridstackNode = l), (l.el = e);
                  var c =
                    null ===
                      (a =
                        null === (r = l.subGrid) || void 0 === r
                          ? void 0
                          : r.el) || void 0 === a
                      ? void 0
                      : a.gridstack;
                  return (
                    s.Utils.copyPos(l, i._readAttr(i.placeholder)),
                    s.Utils.removePositioningStyles(e),
                    i._writeAttr(e, l),
                    i.el.appendChild(e),
                    c &&
                      ((c.parentGridItem = l),
                      c.opts.styleInHead || c._updateStyles(!0)),
                    i._updateContainerHeight(),
                    i.engine.addedNodes.push(l),
                    i._triggerAddEvent(),
                    i._triggerChangeEvent(),
                    i.engine.endUpdate(),
                    i._gsEventHandler.dropped &&
                      i._gsEventHandler.dropped(
                        o(o({}, t), { type: "dropped" }),
                        u && u.grid ? u : void 0,
                        l
                    ...
                    window.setTimeout(function () {
                      l.el && l.el.parentElement
                        ? i._prepareDragDropByNode(l)
                        : i.engine.removeNode(l),
                        delete l.grid._isTemp;
                    }),
                    !1
                  );
                }),
            ...
            (r.GridStack.setupDragIn = function (t, e) {
              void 0 !== (null == e ? void 0 : e.pause) &&
                (a.DDManager.pauseDrag = e.pause),
                "string" == typeof t &&
                  ((e = o(o({}, n.dragInDefaultOptions), e || {})),
                  s.Utils.getElements(t).forEach(function (t) {
                    h.isDraggable(t) || h.dragIn(t, e);
                  }));
            }),
            (r.GridStack.prototype._prepareDragDropByNode = function (t) {
              ...
              if (this.opts.staticGrid || (o && n))
                return (
                  t._initDD && (this._removeDD(i), delete t._initDD),
                  i.classList.add(
              ...
              if (!t._initDD) {
                var r,
                  a,
                  l = function (o, n) {
                    e._gsEventHandler[o.type] &&
                      e._gsEventHandler[o.type](o, o.target),
                      (r = e.cellWidth()),
                      (a = e.getCellHeight(!0)),
                      e._onStartMoving(i, o, n, t, r, a);
                  },
                  d = function (o, n) {
                    e._dragOrResize(i, o, n, t, r, a);
                  },
                  u = function (o) {
                    ...
                    if (n.gridstackNode && n.gridstackNode.grid === e) {
                      if (((t.el = n), t._isAboutToRemove)) {
                        ...
                        r._gsEventHandler[o.type] &&
                          r._gsEventHandler[o.type](o, n),
                          e._removeDD(i),
                        ...
                        s.Utils.removePositioningStyles(n),
                          t._temporaryRemoved
                ...
                h
                  .draggable(i, { start: l, stop: u, drag: d })
                  .resizable(i, { start: l, stop: u, resize: d }),
                  (t._initDD = !0);
              }
              return (
                h
                  .draggable(i, o ? "disable" : "enable")
                  .resizable(i, n ? "disable" : "enable"),
                this
              );
            }),
            (r.GridStack.prototype._onStartMoving = function (
              t,
              e,
              i,
              o,
              ...
              this.engine.cleanNodes().beginUpdate(o),
                ...
                "resizestart" === e.type &&
                  ...
                  o.maxW && h.resizable(t, "option", "maxWidth", n * o.maxW),
                  o.maxH && h.resizable(t, "option", "maxHeight", r * o.maxH));
            }),
            (r.GridStack.prototype._leave = function (t, e) {
              ...
              i &&
                ...
                i._temporaryRemoved ||
                  ...
                  t._gridstackNodeOrig
                    ? ((t.gridstackNode = t._gridstackNodeOrig),
            ...
            (r.GridStack.prototype._dragOrResize = function (t, e, i, n, r, a) {
              var l,
                d = o({}, n._orig),
              ...
              if (
                ...
                (n._prevYPix = i.position.top),
                  s.Utils.updateScrollPosition(t, i.position, f);
                var v =
                    i.position.left +
                    (i.position.left > n._lastUiPosition.left ? -u : h),
                  y =
                    i.position.top +
                    (i.position.top > n._lastUiPosition.top ? -c : p);
                (d.x = Math.round(v / r)), (d.y = Math.round(y / a));
                ...
                if (d.x < 0) return;
                if (
                  (s.Utils.updateScrollResize(e, t, a),
                  (d.w = Math.round((i.size.width - h) / r)),
                  (d.h = Math.round((i.size.height - p) / a)),
                  n.w === d.w && n.h === d.h)
                )
                  return;
                if (
                ...
                (d.x = Math.round(v / r)), (d.y = Math.round(E / a)), (l = !0);
              }
              ...
              var D = {
                ...
                h: (i.size ? i.size.height : n.h * a) - p - c,
              };
              if (
                ...
                (n._lastUiPosition = i.position),
                  this.engine.cacheRects(r, a, p, u, c, h),
                  delete n._skipDown,
                  l && n.subGrid && n.subGrid.onParentResize(),
                  (this._extraDragRow = 0),
                  this._updateContainerHeight();
                var x = e.target;
                this._writePosAttr(x, n),
                  this._gsEventHandler[e.type] &&
                    this._gsEventHandler[e.type](e, x);
              }
            }),
            (r.GridStack.prototype.movable = function (t, e) {
              ...
              return (
                this.opts.staticGrid ||
                  r.GridStack.getElements(t).forEach(function (t) {
                    var o = t.gridstackNode;
                    o &&
                      (e ? delete o.noMove : (o.noMove = !0),
              ...
              return (
                this.opts.staticGrid ||
                  r.GridStack.getElements(t).forEach(function (t) {
                    var o = t.gridstackNode;
                    o &&
                      (e ? delete o.noResize : (o.noResize = !0),
                      i._prepareDragDropByNode(o));
                  }),
                this
              );
            ...
            (r.GridStack.prototype.enableMove = function (t) {
              var e = this;
              return (
                this.opts.staticGrid ||
            ...
            (r.GridStack.prototype.enableResize = function (t) {
              var e = this;
              return (
                this.opts.staticGrid ||
            ...
            (r.GridStack.prototype._removeDD = function (t) {
              return (
                h.draggable(t, "destroy").resizable(t, "destroy"),
              ...
              return (
                (t.prototype._init = function () {
                  ...
                  return (
                    ...
                    o.isTouch &&
                      (this.el.addEventListener("touchstart", o.touchstart),
                ...
                (t.prototype.destroy = function () {
                  return (
                    ...
                    o.isTouch &&
                      (this.el.removeEventListener("touchstart", o.touchstart),
                      this.el.removeEventListener(
                        "pointerdown",
                        o.pointerdown
                      )),
                ...
                (t.prototype._mouseDown = function (t) {
                  (this.mouseDownEvent = t),
                    ...
                    document.addEventListener("mouseup", this._mouseUp, !0),
                    o.isTouch &&
                      (this.el.addEventListener("touchmove", o.touchmove),
                ...
                (t.prototype._mouseUp = function (t) {
                  this.moving && this._triggerEvent("stop", t),
                    ...
                    document.removeEventListener("mouseup", this._mouseUp, !0),
                    o.isTouch &&
                      (this.el.removeEventListener("touchmove", o.touchmove),
            ...
            d = (function (t) {
              ...
              return (
                  ...
                  return (
                    t
                      ...
                      : (this.el.classList.remove("ui-resizable-autohide"),
                        ...
                        l.DDManager.overResizeElement === this &&
                          delete l.DDManager.overResizeElement),
                    this
                  );
                }),
                (e.prototype._mouseOver = function (t) {
                  l.DDManager.overResizeElement ||
                    l.DDManager.dragElement ||
                    ((l.DDManager.overResizeElement = this),
                    this.el.classList.remove("ui-resizable-autohide"));
                }),
                ...
                (e.prototype._setupHelper = function () {
                  var t = this;
                  return (
                    (this.elOriginStyleVal = e._originStyleProp.map(function (
                      e
                    ) {
                      return t.el.style[e];
                    })),
                ...
                (e.prototype._getChange = function (t, e) {
                  ...
                  return (
                    Math.round(o.width) !== Math.round(s.width) &&
                      (e.indexOf("w") > -1 && (o.left += o.width - s.width),
                      (o.width = s.width)),
        ...
        537: function (t, e, i) {
          ...
          (e.touchstart = function (t) {
            ...
            (e.touchend = function (t) {
              if (n.touchHandled) {
                n.pointerLeaveTimeout &&
                  (window.clearTimeout(n.pointerLeaveTimeout),
            ...
            (e.pointerenter = function (t) {
              o.DDManager.dragElement && s(t, "mouseenter");
            }),
            (e.pointerleave = function (t) {
              o.DDManager.dragElement &&
                (n.pointerLeaveTimeout = window.setTimeout(function () {
              ...
              return (
                ...
                (t.prototype._fixCollisions = function (t, e, i, r) {
                  if (
                    ...
                    return !1;
                  if (t._moving && !r.nested && !this.float && this.swap(t, i))
                    return !0;
                  var s = e;
                ...
                (t.prototype.sortNodes = function (t) {
                  return (
                    (this.nodes = n.Utils.sort(this.nodes, t, this.column)),
                    this
                  );
                }),
                        ...
                        : this.nodes.forEach(function (e, i) {
                            if (!e.locked)
                              for (; e.y > 0; ) {
                                ...
                                if (
                                  0 !== i &&
                                  t.collide(e, { x: e.x, y: o, w: e.w, h: e.h })
                                )
                                  break;
                ...
                (t.prototype.restoreInitial = function () {
                  return (
                    this.nodes.forEach(function (t) {
                      n.Utils.samePos(t, t._orig) ||
                        (n.Utils.copyPos(t, t._orig), (t._dirty = !0));
                    }),
                    this._notify(),
                    this
                  );
                ...
                (t.prototype.willItFit = function (e) {
                  ...
                  return (
                    ...
                    delete r.grid,
                    i.addNode(r),
                    i.getRow() <= this.maxRow &&
                      ((e._willFitPos = n.Utils.copyPos({}, r)), !0)
                  );
                }),
                ...
                (t.prototype.moveNode = function (t, e) {
                  ...
                  if (d.length) {
                    ...
                    if (
                      ...
                      c / (g < m ? g : m) > 0.8 &&
                        (p.grid.makeSubGrid(p.el, void 0, t), (p = void 0));
                    }
                    p
                      ? (h = !this._fixCollisions(t, a, p, e))
                      : ((h = !1), r && delete e.pack);
                  }
                  return (
                    h && ((t._dirty = !0), n.Utils.copyPos(t, a)),
                ...
                (t.prototype.save = function (t) {
                  ...
                  void 0 === t && (t = !0);
                  var i =
                      null === (e = this._layouts) || void 0 === e
                        ? void 0
                        : e.length,
                    r =
                      i && this.column !== i - 1 ? this._layouts[i - 1] : null,
                    s = [];
                  return (
                    this.sortNodes(),
                    this.nodes.forEach(function (e) {
                      var i =
                        ...
                        a = o({}, e);
                      i && ((a.x = i.x), (a.y = i.y), (a.w = i.w)),
                        n.Utils.removeInternalForSave(a, !t),
                        s.push(a);
                    }),
                    s
                  );
                          ...
                          t.forEach(function (t) {
                            if (t._orig) {
                              ...
                              e &&
                                ...
                                t.x !== t._orig.x &&
                                  (e.x = Math.round(t.x * n)),
                                t.w !== t._orig.w &&
                                  (e.w = Math.round(t.w * n)));
                            }
                          });
                        }
                      }),
                ...
                (t.prototype.updateNodeWidths = function (t, e, i, o) {
                  ...
                  if (e > t) {
                    ...
                    !h.length &&
                      t !== u &&
                      (null === (r = this._layouts[u]) || void 0 === r
                        ? void 0
                        : r.length) &&
                      ((t = u),
        ...
        324: function (t, e, i) {
          var o =
            ...
            r =
              ...
              function (t, e) {
                for (var i in t)
                  "default" === i || e.hasOwnProperty(i) || n(e, t, i);
              },
            s =
          ...
          var h = (function () {
            function t(e, i) {
              ...
              void 0 === i && (i = {}),
                ...
                (this.el = e),
                (i = i || {}).row &&
                  ((i.minRow = i.maxRow = i.row), delete i.row);
              var h = l.Utils.toNumber(e.getAttribute("gs-row"));
              "auto" === i.column && delete i.column;
              var c = i;
              void 0 !== c.minWidth &&
                ((i.oneColumnSize = i.oneColumnSize || c.minWidth),
                delete c.minWidth),
                void 0 !== i.alwaysShowResizeHandle &&
                  (i._alwaysShowResizeHandle = i.alwaysShowResizeHandle);
              var g = o(o({}, l.Utils.cloneDeep(d.gridDefaults)), {
                column:
                  l.Utils.toNumber(e.getAttribute("gs-column")) ||
                  d.gridDefaults.column,
                minRow:
                  h ||
                  l.Utils.toNumber(e.getAttribute("gs-min-row")) ||
                  d.gridDefaults.minRow,
                maxRow:
                  h ||
                  l.Utils.toNumber(e.getAttribute("gs-max-row")) ||
                  d.gridDefaults.maxRow,
                staticGrid:
                  l.Utils.toBool(e.getAttribute("gs-static")) ||
                  d.gridDefaults.staticGrid,
                draggable: {
                  handle:
                    (i.handleClass
                      ? "." + i.handleClass
                      : i.handle
                      ? i.handle
                      : "") || d.gridDefaults.draggable.handle,
                },
                removableOptions: {
                  accept: i.itemClass
                    ? "." + i.itemClass
                    : d.gridDefaults.removableOptions.accept,
                },
              });
              e.getAttribute("gs-animate") &&
                (g.animate = l.Utils.toBool(e.getAttribute("gs-animate"))),
                (this.opts = l.Utils.defaults(i, g)),
                (i = null),
                this._initMargin(),
                1 !== this.opts.column &&
              ...
              var m =
                null ===
                  (n = l.Utils.closestUpByClass(
                    this.el,
                    d.gridDefaults.itemClass
                  )) || void 0 === n
                  ? void 0
                  : n.gridstackNode;
              m &&
                ((m.subGrid = this),
                (this.parentGridItem = m),
                this.el.classList.add("grid-stack-nested"),
                m.el.classList.add("grid-stack-sub-grid")),
                ...
                "mobile" === this.opts.alwaysShowResizeHandle &&
                  (this.opts.alwaysShowResizeHandle = u.isTouch),
                (this._styleSheetClass =
                  "grid-stack-instance-" + a.GridStackEngine._idSeq++),
                this.el.classList.add(this._styleSheetClass),
                this._setStaticClass();
              var f =
                this.opts.engineClass || t.engineClass || a.GridStackEngine;
              if (
                ((this.engine = new f({
                  ...
                  onChange: function (t) {
                    var e = 0;
                    s.engine.nodes.forEach(function (t) {
                ...
                this.getGridItems().forEach(function (t) {
                  ...
                  v.push({
                    el: t,
                    i:
                      (Number.isNaN(e) ? 1e3 : e) +
                      (Number.isNaN(i) ? 1e3 : i) * s.getColumn(),
                  });
                }),
                  v
                    .sort(function (t, e) {
              ...
              this.setAnimation(this.opts.animate),
                ...
                this.opts.dragIn &&
                  t.setupDragIn(this.opts.dragIn, this.opts.dragInOptions),
                delete this.opts.dragIn,
                delete this.opts.dragInOptions,
                this.opts.subGridDynamic &&
                  !p.DDManager.pauseDrag &&
                  (p.DDManager.pauseDrag = !0),
                void 0 !==
                  (null === (r = this.opts.draggable) || void 0 === r
                    ? void 0
                    : r.pause) &&
                  (p.DDManager.pauseDrag = this.opts.draggable.pause),
            ...
            return (
              (t.init = function (e, i) {
                ...
                return o
                  ? (o.gridstack ||
                      (o.gridstack = new t(o, l.Utils.cloneDeep(e))),
                    o.gridstack)
                  : ("string" == typeof i
                      ? console.error(
              ...
              (t.addGrid = function (e, i) {
                ...
                if (!e.classList.contains("grid-stack")) {
                  ...
                  (n.body.innerHTML =
                    '<div class="grid-stack ' + (i.class || "") + '"></div>'),
                    (o = n.body.children[0]),
                    e.appendChild(o);
                }
                var r = t.init(i, o);
                  ...
                  if (!this._placeholder) {
                    ...
                    (t.className = "placeholder-content"),
                      this.opts.placeholderText &&
                        (t.innerHTML = this.opts.placeholderText),
              ...
              (t.prototype.addWidget = function (t, e) {
                ...
                var h = this._readAttr(s);
                (e = l.Utils.cloneDeep(e) || {}), l.Utils.defaults(e, h);
                var u = this.engine.prepareNode(e);
                return (
                  this._writeAttr(s, e),
                  this._insertNotAppend
                    ? this.el.prepend(s)
                    : this.el.appendChild(s),
                  this._prepareElement(s, !0, e),
                  this._updateContainerHeight(),
                  u.subGrid && this.makeSubGrid(u.el, void 0, void 0, !1),
              ...
              (t.prototype.makeSubGrid = function (e, i, n, r) {
                ...
                var a,
                  d = e.gridstackNode;
                if (
                  (d || (d = this.makeWidget(e).gridstackNode),
                  null === (s = d.subGrid) || void 0 === s ? void 0 : s.el)
                )
                  return d.subGrid;
                ((i = l.Utils.cloneDeep(
                  i ||
                    d.subGrid ||
                    o(o({}, this.opts.subGrid), { children: void 0 })
                )).subGrid = l.Utils.cloneDeep(i)),
                  (d.subGrid = i),
                  "auto" === i.column &&
                    ((a = !0),
                    (i.column = Math.max(
                ...
                var h,
                  u,
                  p = d.el.querySelector(".grid-stack-item-content");
                if (r) {
                  this._removeDD(d.el);
                  var c = document.implementation.createHTMLDocument("");
                  (c.body.innerHTML = '<div class="grid-stack-item"></div>'),
                    (h = c.body.children[0]).appendChild(p),
                    (u = o(o({}, d), { x: 0, y: 0 })),
                    l.Utils.removeInternalForSave(u),
                    delete u.subGrid,
                    d.content && ((u.content = d.content), delete d.content),
                    (c.body.innerHTML =
                      '<div class="grid-stack-item-content"></div>'),
                    (p = c.body.children[0]),
                    d.el.appendChild(p),
                    this._prepareDragDropByNode(d);
                }
                if (n) {
                  var g = a ? i.column : d.w,
                    m = d.h + n.h,
                    f = d.el.style;
                  (f.transition = "none"),
                    this.update(d.el, { w: g, h: m }),
                    setTimeout(function () {
                      return (f.transition = null);
                    });
                }
                var v = (d.subGrid = t.addGrid(p, i));
                return (
                  (null == n ? void 0 : n._moving) && (v._isTemp = !0),
                  a && (v._autoColumn = !0),
                  r && v.addWidget(h, u),
                  n &&
                    (n._moving
                      ? window.setTimeout(function () {
                          return l.Utils.simulateMouseEvent(
                            n._event,
                            "mouseenter",
                            v.el
                          );
              ...
              (t.prototype.removeAsSubGrid = function (t) {
                var e,
                  i = this,
                  o =
                    null === (e = this.parentGridItem) || void 0 === e
                      ? void 0
                      : e.grid;
                o &&
                  (o.batchUpdate(),
                ...
                if (
                  (i.forEach(function (e) {
                    if (t && e.el && !e.subGrid) {
                      ...
                      (e.content = i ? i.innerHTML : void 0),
                  ...
                  o.marginBottom === o.marginTop &&
                    ...
                    delete o.marginLeft),
                    o.rtl === ("rtl" === this.el.style.direction) &&
                      (o.rtl = "auto"),
                    this._isAutoCellHeight && (o.cellHeight = "auto"),
                    this._autoColumn &&
                      ((o.column = "auto"), delete o.disableOneColumnMode);
                  var n = o._alwaysShowResizeHandle;
                  return (
                    delete o._alwaysShowResizeHandle,
                    void 0 !== n
                      ? (o.alwaysShowResizeHandle = n)
                      : delete o.alwaysShowResizeHandle,
                    l.Utils.removeInternalAndSame(o, d.gridDefaults),
                    (o.children = i),
                    o
                  );
                }
              ...
              (t.prototype.load = function (e, i) {
                ...
                return (
                  ...
                  n.forEach(function (t) {
                    ...
                    if (e) {
                      if (
                        (o.update(e.el, t), t.subGrid && t.subGrid.children)
                      ) {
                        var n = e.el.querySelector(".grid-stack");
                        n &&
                          n.gridstack &&
                          (n.gridstack.load(t.subGrid.children),
                          (o._insertNotAppend = !0));
                      }
                    } else i && (t = "function" == typeof i ? i(o, t, !0).gridstackNode : o.addWidget(t).gridstackNode);
                  }),
              ...
              (t.prototype.getCellHeight = function (t) {
                ...
                return o
                  ? Math.round(this.el.getBoundingClientRect().height / o)
                  : this.opts.cellHeight;
              }),
              ...
              (t.prototype.column = function (t, e) {
                if (
                  (void 0 === e && (e = "moveScale"),
                  t < 1 || this.opts.column === t)
                )
                  return this;
                var i,
                  o = this.getColumn();
              ...
              (t.prototype.getGridItems = function () {
                ...
                return Array.from(this.el.children).filter(function (e) {
                  return (
                    e.matches("." + t.opts.itemClass) &&
                    !e.matches("." + t.opts.placeholderClass)
                  );
                });
              }),
              ...
              (t.prototype.float = function (t) {
                return (
                  this.opts.float !== t &&
                    ((this.opts.float = this.engine.float = t),
                    this._triggerChangeEvent()),
                  this
                );
              }),
              ...
              (t.prototype.getCellFromPixel = function (t, e) {
                ...
                var n = t.left - i.left,
                  ...
                  a =
                    o.height / parseInt(this.el.getAttribute("gs-current-row"));
              ...
              (t.prototype._removeStylesheet = function () {
                return (
                  this._styles &&
                    (l.Utils.removeStylesheet(this._styleSheetClass),
                    delete this._styles),
                  this
                );
              }),
              (t.prototype._updateStyles = function (t, e) {
                ...
                var i = this.opts.cellHeight,
                  ...
                  n =
                    "." + this._styleSheetClass + " > ." + this.opts.itemClass;
                if (!this._styles) {
                  var r = this.opts.styleInHead ? void 0 : this.el.parentNode;
                  if (
                    ((this._styles = l.Utils.createStylesheet(
                      this._styleSheetClass,
                      r
                    )),
                    !this._styles)
                ...
                if ((e = e || this._styles._max) > this._styles._max) {
                  ...
                  var minHeightStr = this.el.style.minHeight;
                  var minHeight = parseInt(minHeightStr, 10);
                  var m = (minHeight * 0.33) + "px";
                  var c = function (t) {
                    return Math.floor(t / 3) * parseFloat(m) + "px";
                  };
                  // var c = function (t) { return i * t + o;}
                  for (var g = this._styles._max + 1;g <= e; g++) {
                    // var m = c(g);
                    l.Utils.addCSSRule(
                      this._styles,
                      n + '[gs-y="' + (g - 1) + '"]',
              ...
              (t.prototype._updateContainerHeight = function () {
                ...
                // 'menu-side' 요소의 높이를 가져옵니다.
                var menuSideElement = document.getElementById('menu-side');
                var menuSideHeight = menuSideElement ? menuSideElement.style.height : null;
                ...
                if (menuSideHeight) {
                  // 'px'를 제거하고 숫자로 변환한 후 16을 뺍니다.
                  var adjustedHeight = parseInt(menuSideHeight, 10) - 16;
                  // 숫자를 다시 'px' 단위의 문자열로 변환합니다.
                  this.el.style.minHeight = adjustedHeight + 'px';
          
                  // 'minHeight'를 33%로 줄인 값을 사용하여 'gs-h' 높이 설정
                  var minHeightStr = this.el.style.minHeight;
                  var minHeight = parseInt(minHeightStr, 10);
                  var m = (minHeight * 0.33) + "px";
                  var mm = (minHeight * 0.66) + "px";
              ...
              return e ? ((this.el.style.minHeight = t * m), this) : this;
                  ...
                  // // 요소의 높이가 있으면 'minHeight'를 설정합니다.
                  // if (menuSideHeight) {
                  //   // 'px'를 제거하고 숫자로 변환한 후 5를 뺍니다.
                  //   var adjustedHeight = parseInt(menuSideHeight, 10) - 16;
                  //   // 숫자를 다시 'px' 단위의 문자열로 변환합니다.
                  //   this.el.style.minHeight = adjustedHeight + 'px';
              ...
              (t.prototype._writeAttr = function (t, e) {
                ...
                for (var o in i)
                  e[o]
                    ? t.setAttribute(i[o], String(e[o]))
                    : t.removeAttribute(i[o]);
                return this;
              }),
              ...
              (t.prototype.onParentResize = function () {
                ...
                if (this.el && this.el.clientWidth) {
                  ...
                  if (this._autoColumn && this.parentGridItem)
                    ...
                    (1 === this.opts.column) !== i &&
                      ((e = !0),
                      this.opts.animate && this.setAnimation(!1),
                      this.column(i ? 1 : this._prevColumn),
                    ...
                    this._isAutoCellHeight &&
                      (!e && this.opts.cellHeightThrottle
                        ? (this._cellHeightThrottle ||
                            (this._cellHeightThrottle = l.Utils.throttle(
                              function () {
                                return t.cellHeight();
                              },
        ...
        867: function (t, e) {
          ...
          Object.defineProperty(e, "__esModule", { value: !0 }),
            ...
            (e.obsoleteOptsDel = function (t, e, i, o) {
              void 0 !== t[e] &&
                console.warn(
                  "gridstack.js: Option `" + e + "` is deprecated in " + i + o
                );
            }),
